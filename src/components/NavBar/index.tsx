  ...
  return (
    <nav
      ...
      className={classNames(
        'w-full h-[80px] bg-transparent flex items-center justify-between  wrapper fixed z-10 transition-all duration-200'
      )}
    >
      <div className="nav-logo font-bold text-3xl transition-all text-white">
        COMPANY LOGO
      </div>
      <div className="flex gap-4 uppercase text-sm font-semibold transition-all items-center text-white">
        ...
        <div className="nav-list cursor-pointer hover:text-primary">Learn</div>
        <div className="nav-list cursor-pointer hover:text-primary">
          Contact Us
        </div>
