...
export const PricingStartsAt = () => {
  return (
    <Container parentClassName="overflow-hidden" className="py-32">
      ...
      <div className="rounded-lg shadow-lg p-14 bg-primary/30">
        <div className="flex">
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-5 text-black/90">
            ...
            <div className="mt-10">
              <button className="bg-secondary py-4 px-9 text-white rounded-md shadow-md font-bold transition-colors hover:bg-transparent ">
                SEE PRICING OPTIONS
              </button>
            </div>
          </div>
