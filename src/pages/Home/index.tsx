  ...
  return (
    <div>
      <section className="relative" ref={ref as any}>
        <div className="h-[530px] lg:h-[75vh] bg-gray-900">
          <img
            src={HeroImage}
            alt="banner"
          ...
          <div className="flex justify-center items-center relative h-[80%]">
            <div className="text-[3.5rem] absolute text-white text-center top-32 lg:top-56">
            ...
            <button
              className={classNames(
                'text-black text-lg font-bold absolute bottom-16 py-3 px-6 bg-secondary tracking-wide  rounded-full transition-all duration-500 lg:bottom-24 border-solid border-2 border-secondary',
      ...
      <section className="relative">
        <div className="min-h-[500px] bg-[#ebf4f3]">
          <div className="wrapper py-8">
            <div className="text-center text-[38px] mb-12">
              Tell us{' '}
            ...
            <div className="flex gap-10">
              <div className="flex flex-col px-14 pb-32 flex-1">
                <img
                  src="https://outsourcingangel.com/wp-content/uploads/2022/04/Angel-Icon.jpg"
                  alt=""
                  className="w-[140px] h-[140px] mx-auto mb-6"
                />
                <div className="text-[28px] text-center mb-6">
                  I need a <span className="font-bold">Virtual Assistant</span>{' '}
                  to help me with marketing, admin and more
                </div>
                <div className="text-center text-[17px] px-5 mb-8">
                  We’ll recruit, hire, on-board a Filipino Virtual Assistant
                  that fits the demands of your business, schedule and style.
                </div>
                <button
                  className={classNames(
                    'rounded-full transition-all duration-500 text-black font-bold text-lg w-fit px-7 py-3 mx-auto border-2 border-solid border-primary mt-auto',
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="wrapper min-h-[500px] py-8">
          <div className="w-1/2">
            <div className="text-[38px] leading-tight">
              Here’s what your{' '}
          ...
          <div className="w-full mt-16">
            <div className="flex gap-6 cursor-pointer">
              <div className="flex flex-col w-[350px] min-w-[350px] p-10 items-center text-center border border-solid border-primary rounded-xl">
                <img
      ...
      <section className="relative py-14">
        <div className="wrapper">
          <div className="w-full h-52 rounded-2xl bg-secondary">
            <div className="flex items-center justify-between h-full px-20">
              <div className="pr-20 text-[25px] font-bold">
                Do you want to simplify and automate your business with
                intelligent digital tools and experienced Virtual Assistants?
              </div>
              <button className="py-4 px-7 rounded-full bg-primary text-white font-bold tracking-wide min-w-fit">
                LET'S CHAT
              </button>
            </div>
          </div>
      ...
      <section className="relative py-14">
        <div className="wrapper pb-16">
          <div className="px-44">
            <div className="text-[38px] text-center mb-6">
              How our{' '}
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 ">
                  <img
                    ...
                    className="h-10"
                  />
                  <div className="font-bold text-[38px] leading-none">
                    Discovery Call
                  </div>
                </div>
                <div className="text-[17px] mt-7">
      ...
      <section className="relative bg-[#ebf4f3] pb-32">
        <div className="wrapper">
          <div className="w-1/2">
      ...
      <section className="relative pb-16">
        <div className="wrapper">
          ...
          <div className="rounded-2xl mt-8 overflow-hidden">
            <div className="flex">
              <div className="flex-1">
                <img
              ...
              <div className="flex-1">
                <div className="bg-secondary w-full h-full py-10 px-12">
                  <div className="font-bold text-xl">
                    Steve Jobs, Founder Microsoft
                  </div>
                  <div className="text-lg mb-8">Manila City, Philippines</div>
                  <div className="mb-8">
          ...
          <div className="mt-12 text-center">
            <button className="rounded-full py-4 px-7 bg-primary text-white font-bold">
              LEARN MORE
            </button>
          </div>
        </div>
      ...
      <section className="relative pb-16">
        <div className="wrapper">
          <div className="w-full rounded-2xl bg-[#ebf4f3] py-11">
            <div className="flex items-center justify-between h-full px-20 gap-8">
              <img
